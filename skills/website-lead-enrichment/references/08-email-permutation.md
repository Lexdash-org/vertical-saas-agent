...
The table is **not** written out in code. It lives in `../scripts/lib/patterns.json` as
an ordered list of names, and both `permute.ts` and `scripts/lib/patterns.ts` derive their
