 ...
 *
 *   npx tsx scripts/discover-team-pages/rank-one.ts qldxray.com.au
 *   npx tsx scripts/discover-team-pages/rank-one.ts https://advaraheartcare.com --company "Advara HeartCare" --json
 *
...
if (!website) {
  console.error('usage: npx tsx scripts/discover-team-pages/rank-one.ts <website> [--company "Name"] [--min-score 85] [--max-pages 5] [--json]');
  process.exit(1);
}
